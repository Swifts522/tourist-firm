...
.button
{
 ...
 box-shadow:0px 0px 2px #bababa, inset 0px 0px 1px #ffffff;  
    ...
    <body>	
		<?php
				if (!isset($_SESSION['autorizationflag']))
				{
				...
				else
 				{
					...
					else
					{
						...
						$query = "SELECT ID FROM accounts WHERE Name = '$login' AND Password = '$password'";
						...
						if(mysql_num_rows($res) == 0)
						{
							...
							<div class = 'textregistation2'>Неверный логин или пароль.</div>";	
						}
						else
						{
